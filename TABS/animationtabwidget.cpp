...
void animationTabWidget::initControls(){
    ...
    next->setStyleSheet("QPushButton { background-image: url(images/Next.png); border-radius: 10px;} QPushButton:hover { background-image: url(images/NextPressed.png)} ");
    next->setFlat(true);
    next->setAutoFillBackground(true);

    previous->setStyleSheet("QPushButton { background-image: url(images/Previous.png);border-radius: 10px;} QPushButton:hover { background-image: url(images/PreviousPressed.png)} ");
    previous->setFlat(true);
    previous->setAutoFillBackground(true);

    reset->setStyleSheet("QPushButton { background-image: url(images/Stop.png);border-radius: 10px;} QPushButton:hover { background-image: url(images/StopPressed.png)} ");
    reset->setFlat(true);
    reset->setAutoFillBackground(true);

    pause->setStyleSheet("QPushButton { background-image: url(images/Pause.png); border-radius: 10px;} QPushButton:hover { background-image: url(images/PausePressed.png)} ");
    pause->setFlat(true);
    pause->setAutoFillBackground(true);

    play->setStyleSheet("QPushButton { background-image: url(images/Play.png); border-radius: 10px;} QPushButton:hover { background-image: url(images/PlayPressed.png)} ");
    play->setFlat(true);
